...
// ── SHELL ──────────────────────────────────────────────────────────────────────
function Shell({user,page,setPage,onLogout,clients,children}){
...
export default function App(){
  ...
  return(
    <div style={S.app}>
      <Shell user={user} page={page} setPage={setPage} clients={clients} onLogout={()=>{setUser(null);setPage("dashboard");setItems([]);setMovements([]);}}>
